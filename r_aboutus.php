<?php include("rheader.php");?>
      <div class="container-fluid">
            <div class="row">
                  <div class="col-md-12">
				<h1 align="center" style="color:lightblue; font-weight:bold; font-size:50px; border:3px dashed blue">ABOUT</h1><hr>
                 </div>
	        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             <span style='font-weight:bold; background:#4e8af7;color:white;font-size:30px'>Corporater Details</span>
                        </div>
					

					<center>
                     <form action="">
					   <table class="table table-striped table-bordered table-hover" border="5px solid lightblue">
                    ...
                    <tr>
                    <td><?php print $row['co_name'];?></td>
                    <td><?php print $row['co_designation'];?></td>
                    <td><?php print $row['co_email'];?></td>
                    <td><?php print $row['co_phone'];?></td>
                    <td><?php print $row['co_address'];?></td>
                    </tr>
...
<div class="col-md-4">
	  ...
	  <img src="images/index1.jpg" class="img_fluid" width="450px" height="800px">
						
</div>			
			
<div class="col-md-8" style="text-align:justify;color:#000;">
<p style="font-size:30px;font-weight:bold;background:#4e8af7;color:white;">History</p><br>
...
<p style="font-size:30px;font-weight:bold;background:#4e8af7;color:white;">Legends</p><br>
