               ...
               <div class="row">
                  <div class="col-md-12">
                     ...
                     <form action="">
					  ...
					  <?php
					  include ("connect.php");
					  $q="select * from divorce_application where user_id=$user_id";
					...
					<!--<td><a class="btn btn-info" href="divorce_editdata.php?div_id=<?php print $row['div_id'];?>">Edit</a></td>-->
					  <td><a class="btn btn-danger" href="r_divorce_delete.php?div_id=<?php print $row['div_id'];?>"><img src="images/delete1.png" width="40px" height="40px">Delete</a></td>
					  <td><a class="btn btn-info" href="r_divorce_remarks.php?div_id=<?php print $row['div_id'];?>"><img src="images/eye1.png" width="40px" height="40px">View</a></td>
					  </tr>
					  <?php
						}
					  ?>
