               ...
               <div class="row">
                  <div class="col-md-12">
                     ...
                     <form action="">
					  ...
					  <td><img width="200px" height="200px" src="<?php print $row['mrg_invitation'];?>"></td>
					 ...
					 <td><a class="btn btn-danger" href="a_mrg_delete.php?mrg_id=<?php print $row['mrg_id'];?>"><img src="images/delete1.png" width="40px" height="40px">Delete</a></td>
					 <td><a class="btn btn-info" href="a_mrg_remarks.php?mrg_id=<?php print $row['mrg_id'];?>"><img src="images/eye1.png" width="40px" height="40px">View</a></td>
