<?php
	...
	$q="insert into mrg_application(user_id,groom_name,groom_fathername,groom_mothername,groom_birth_of_date,groom_address,groom_religion,groom_nationality,groom_marital_status,groom_mobile,groom_email,bride_name,bride_fathername,bride_mothername,bride_birth_of_date,bride_address,bride_religion,bride_nationality,bride_marital_status,bride_mobile,bride_email,mrg_invitation,mrg_date,mrg_place,mrg_photo,brahmin_id,brahmin_name,brahmin_aadhar_card,witness_id,witness_name,mrg_witness_aadhar_card,witness_mobile)values(1,'$groom_name','$groom_fathername','$groom_mothername','$groom_birth_of_date','$groom_address','$groom_religion','$groom_nationality','$groom_marital_status','$groom_mobile','$groom_email','$bride_name','$bride_fathername','$bride_mothername','$bride_birth_of_date','$bride_address','$bride_religion','$bride_nationality','$bride_marital_status','$bride_mobile','$bride_email','$mrg_invitation','$mrg_date','$mrg_place','$mrg_photo','$brahmin_id','$brahmin_name','$brahmin_aadhar_card','$witness_id','$witness_name','$mrg_witness_aadhar_card','$witness_mobile')";
	print $q;
	mysqli_query($cn,$q);
	echo "Recored saved...";
?>