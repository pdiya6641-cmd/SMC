               ...
               <div class="row">
                  <div class="col-md-12">
                     ...
                     <form action="">
					  ...
					  <?php
					  include ("connect.php");
					  $q="select * from birth_application";
					  ...
					  <td><a class="btn btn-danger" href="a_birth_delete.php?birth_id=<?php print $row['birth_id'];?>"><img src="images/delete1.png" width="40px" height="40px">Delete</a></td>
					  <td><a class="btn btn-info" href="a_birth_remarks.php?birth_id=<?php print $row['birth_id'];?>"><img src="images/eye1.png" width="30px" height="30px">View</i></a></td>
					  </tr>
					  <?php
						}
					  ?>
