               ...
               <div class="row">
                  <div class="col-md-12">
                     ...
                     <form action="">
					  ...
					  <?php
					  include ("connect.php");
					  $q="select * from death_application where user_id=$user_id";
					  ...
					  <td><a class="btn btn-danger" href="r_death_delete.php?death_id=<?php print $row['death_id'];?>"><img src="images/delete1.png" width="40px" height="40px">Delete</a></td>
					  <td><a class="btn btn-info" href="r_death_remarks.php?death_id=<?php print $row['death_id'];?>"><img src="images/eye1.png" width="40px" height="40px">View</a></td>
